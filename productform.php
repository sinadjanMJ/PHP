        ...
        <form action="productsave.php" method="post">
            <div class="">
                <div>
                    ...
                    <label>Product</label>
                    <div>
                        <input type="text" class="" placeholder="Enter Product Name" name="pname" autocomplete="off">
                    </div>
                    <br>
                    <label>Price</label>
                    <div>
                        <input type="text" class="" placeholder="Enter Product Price" name="price" autocomplete="off">
                    </div>
                </div>
                <br>
